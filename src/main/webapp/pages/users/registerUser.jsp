            ...
            <form action="registerUser" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
               ...
               <div>
                ...
                <div class="input-group">           
                    ...
                    <input id="firstName" type="text" class="form-control" placeholder="Ej: Fernando" required>
 
                    <span class="input-group-text">Apellido:</span>
                    <input id="lastName" type="text" class="form-control" placeholder="Ej: Torres" required>									
				</div> 
				
				<br>
            	<div class="input-group">
                    <span class="input-group-text"> Nombre de usuario: </span>
                    <input id="username" type="text" class="form-control" placeholder="Ej: FerTorr123" required>
               </div>   
                 
               <br>
               <div class="input-group">
                    <span class="input-group-text"> Correo electrónico: </span>
                    <input id="email" type="email" class="form-control" placeholder="Ej: fertorres@gmail.com" required>
               	</div> 
