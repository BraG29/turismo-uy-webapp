document.write(`
    <footer class="d-flex flex-wrap justify-content-between py-2 border-top fixed-bottom" style="background-color:aliceblue;">
        <div class="col-md-4 d-flex" style="width:fit-content">
